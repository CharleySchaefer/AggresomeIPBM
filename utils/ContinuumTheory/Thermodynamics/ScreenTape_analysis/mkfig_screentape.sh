...
set ylabel '\huge Intensity ratio' offset 2,0
...
plot 'processed_data.txt' u 1:2:3 w e pt 6 ps 2.8 lc rgb 'black' title '\\Large Experiments',\
 0.245705*exp(0.005909*x) w l lw 5 lc rgb 'red' title '\\Large Flory-Huggins'
...
\begin{figure}[h]
    \includegraphics*{Fig_RNA_length.eps}
\end{figure}
...
mv tmp_figure.ps "Fig_RNA_length.eps"
